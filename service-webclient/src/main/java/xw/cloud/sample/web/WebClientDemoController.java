...
public class WebClientDemoController {
    ...
    public Flux<Tweet> getTweetsNonBlocking() {
        ...
        Flux<Tweet> tweetFlux = loadBalancedWebClientBuilder.build()
                .get()
    ...
    public Mono<String> slow() {
        return loadBalancedWebClientBuilder.build().get().uri("http://"+app+"/slow").retrieve().bodyToMono(String.class).transform(
